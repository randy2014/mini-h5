...
> **状态：历史快照**（文档地图：[`README.md`](README.md)）。常用操作命令仍适用；机器规格与磁盘数据已被
> [`incident-log-202609.md`](incident-log-202609.md) 更新（内存 7.9G、binlog 永久关闭），
> 服务器地址与 SSH 端口以 [`../DEPLOYMENT.md`](../DEPLOYMENT.md) 为准。
